...
// Security & Permissive Headers Middleware for Media and Scripts
...
// Official Rules Master Dataset for Convivencia Validation
const VALID_RULES = {
...
if (require.main === module) {
  app.listen(PORT, () => {
    console.log(`🌿 Umas Community Rules Web 3.1+ running on port ${PORT}`);
  });
}
